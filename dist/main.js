...
var isDev = __webpack_require__(/*! electron-is-dev */ "./node_modules/electron-is-dev/index.js"); // require("electron-reload")(__dirname);
...
function createWindow() {
  ...
  console.log('crating window'); // and load the index.html of the app.

  if (isDev) {
    mainWindow.loadURL('http://localhost:4000');
  } else {
    mainWindow.loadURL("file://".concat(path.join(__dirname, './index.html')));
  } // Open the DevTools.
